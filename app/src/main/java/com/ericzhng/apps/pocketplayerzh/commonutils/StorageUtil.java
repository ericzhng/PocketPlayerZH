package com.ericzhng.apps.pocketplayerzh.commonutils;
...
public class StorageUtil {
    ...
    public void storeAudio(ArrayList<AudioFormat> arrayList) {
    ...
    public ArrayList<AudioFormat> loadAudio() {
        preferences = context.getSharedPreferences(STORAGE_KEY, Context.MODE_PRIVATE);

        Gson gson = new Gson();
        String json = preferences.getString(AUDIO_LIST_KEY, null);

        Type type = new TypeToken<ArrayList<AudioFormat>>() {}.getType();
